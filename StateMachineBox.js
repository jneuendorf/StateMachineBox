...
(function() {
  ...
  window.StateMachineBox = (function() {
    ...
    StateMachineBox.BUTTONS = {
      OK: "<div class=\"button ok companyHoverBGColorForce\" langkey=\"popup.ok\">ok</div>",
      CANCEL: "<div class=\"button cancel companyHoverBGColorForce\" langkey=\"popup.cancel\">cancel</div>",
      NEXT: "<div class=\"button next companyHoverBGColorForce\" langkey=\"popup.next\">next</div>",
      PREV: "<div class=\"button prev companyHoverBGColorForce\" langkey=\"popup.prev\">prev</div>"
    };
    ...
    StateMachineBox.unregisterPopup = function(popup) {
      var idx, p;
      idx = this._popups.indexOf(popup);
      if (idx >= 0) {
    ...
    StateMachineBox.prototype.fireAction = function() {
      ...
      name = name.upper();
      if ((action = CLASS.ACTIONS[name]) != null) {
    ...
    StateMachineBox.prototype.close = function(ignoreCallback) {
      ...
      this._popups = this._popups.except(this);
      if (!ignoreCallback) {
    ...
    StateMachineBox.prototype.changeContent = function(event, from, to) {
      ...
      if (!this.navigation.hasClass("hidden")) {
        this.navigation.find(".companyBGColorForce").switchClass("companyBGColorForce", "", 200);
        this.navigation.find(".dot").eq(idx).switchClass("", "companyBGColorForce", 200);
      }
      return this;
    };
    ...
    StateMachineBox.prototype.draw = function() {
      ...
      if (CLASS.MODE === CLASS.MODES.SINGLE && (CLASS.getActive() != null)) {
      ...
      if (CLASS.MODE === CLASS.MODES.MANY) {
        this.div.draggable({
          handle: ".header"
        }).addClass("draggable");
      } else if (CLASS.MODE === CLASS.MODES.SINGLE) {
